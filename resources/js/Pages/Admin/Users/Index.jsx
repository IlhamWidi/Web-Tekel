                    ...
                    <div className="px-6 py-3 border-t border-gray-200">
                        <div className="flex items-center justify-between">
                            <div className="text-sm text-gray-700">
                                Menampilkan <span className="font-semibold">{users.from}</span> sampai{' '}
                                <span className="font-semibold">{users.to}</span> dari{' '}
                                <span className="font-semibold">{users.total}</span> data
                            </div>
